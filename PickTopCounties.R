...
raw_dens = fread("data_sandbox/Current_Population_Density_RAND_US_1.csv")
raw_pop = fread("data_sandbox/Current_Population_Estimates_RAND_US_1.csv")
...
fwrite(pick, "data_sandbox/Top50LargeCounties.csv")
